...
as
	SELECT CT.X_COORDINATE, CT.Y_COORDINATE, ST.WIDTH, ST.HEIGHT, ST.RADIUS,
        CT.TABLE_STATUS, CT.ID_TABLE, ST.SHAPE_TYPENAME, CT.ID_CANVA
...
as
	SELECT FTY.ID_FOOD, FTA.ID_TABLE, FTY.FOOD_NAME, FTY.FOOD_TYPENAME, FTY.AMOUNT_LEFT,
...
GRANT SELECT ON V_ADMIN_FOODsOnTABLE TO ADMIN

GRANT SELECT ON V_ADMIN_TABLEInCANVA TO ADMIN
